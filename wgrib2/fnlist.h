...
int f_code_table_4_241(int mode, unsigned char **sec, float *data, unsigned int ndata, char *inv, void **local);
int f_code_table_4_242(int mode, unsigned char **sec, float *data, unsigned int ndata, char *inv, void **local);
